...
SECRET_KEY = os.environ.get('SECRET_KEY', 'django-insecure-*nohirgy=s^r^go1h_tr_c*z+uok24p!v0_mfar-y%5$2da4du')
...
CORS_ALLOW_ALL_ORIGINS = True  # tighten to your Netlify URL after testing
